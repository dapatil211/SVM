...
public class ManySVM extends GraphicsProgram{
	...
	public static final Integer[] MENU_CHOICES = {1, 2, 3, 4, 5};
	...
	private static final Color[] COLORS = {Color.GREEN, Color.BLUE, Color.MAGENTA, Color.ORANGE};
