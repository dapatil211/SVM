...
public class Main extends GraphicsProgram{
	...
	public static final Integer[] MENU_CHOICES = {1, 2};
...
//			JOptionPane.showMessageDialog(this, "" + e.getX() + ", " + e.getY());
	...
	private static final Color RED_FIELD = Color.RED.brighter().brighter(), BLUE_FIELD = Color.BLUE.brighter().brighter();
...
//					System.out.println("looping");
					...
					double val = f(alpha, ys, xVals, new Matrix(x, x.length), b, sig);
